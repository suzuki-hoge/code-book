...
export const atcoder: Tag = {
  id: 1,
  name: 'At Coder',
  icon: 'https://tomo-kon.com/wp-content/uploads/2020/06/AtCoder.jpg',
}
...
export const haskell: Tag = {
  id: 3,
  name: 'Haskell',
  icon: 'https://ih1.redbubble.net/image.426834160.5575/st,small,507x507-pad,600x600,f8f8f8.u4.jpg',
}
...
export const mysql: Tag = {
  id: 7,
  name: 'MySQL',
  icon: 'https://p1.hiclipart.com/preview/64/828/885/mysql-logo-organization-database-database-management-system-theory-implementation-line-circle-png-clipart.jpg',
}
