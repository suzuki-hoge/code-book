...
(
    ...
    val0    varchar(4096) not null default '',
    val1    varchar(4096) not null default '',
    val2    varchar(4096) not null default '',
    val3    varchar(4096) not null default '',
    val4    varchar(4096) not null default '',
    val5    varchar(4096) not null default '',
    val6    varchar(4096) not null default '',
    val7    varchar(4096) not null default '',
    val8    varchar(4096) not null default '',
