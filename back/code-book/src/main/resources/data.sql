...
insert into book(id, author_id, emoji, title, description, created)
values ('22222222-2222-4222-8222-222222222222', '22222222-2222-4222-8222-222222222222', '⛳', '022 - Cubic Cake', STRINGDECODE('次回は 9/22 16:00-17:00\n\n* 典型90問\n022 - Cubic Cake（★2）\nhttps://atcoder.jp/contests/typical90/tasks/typical90_v'), '2022/09/08 16:01:43');

insert into book(id, author_id, emoji, title, description, created)
values ('33333333-3333-4333-8333-333333333333', '33333333-3333-4333-8233-333333333333', '🗒️', 'プロジェクトのスニペット', '開発補助とかテストとか', '2022/08/25 17:33:24');
